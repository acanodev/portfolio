/*====AXIOS CONNECTION SERVICE====*/
export const BASE_URL = "/api";

/*====HOME PAGE====*/
export const HOME_PAGE_TITLE = "Aarón Cano - Computer Technician & Junior Full Stack Developer · Home";

export const HOME_MY_NAME = "Aarón Cano";

export const HOME_SUB_TITLE = "Full Stack Developer Computer Technician";
...
export const ABOUT_LONG_TERM =
  "Become a developer with strong knowledge about both development and systems.";
...
export const EXPERIENCE_PAGE_TITLE = "Aarón Cano - Computer Technician & Junior Full Stack Developer · Experience";
